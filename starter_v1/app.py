...
system_prompt = render_system_prompt(prompt_path.read_text(encoding="utf-8"))
declarations = load_tool_declarations(tools_path)
openai_tools = to_openai_tools(declarations)
max_tool_rounds = recommended_max_tool_rounds(declarations)
